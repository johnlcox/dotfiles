...
| OS | Snippet |
|:---:|:---|
| OS X | `bash -c "$(curl -LsS https://raw.github.com/johnlcox/dotfiles/develop/setup.sh)"` |
| Ubuntu | `bash -c "$(wget -qO - https://raw.github.com/johnlcox/dotfiles/develop/setup.sh)"` |
